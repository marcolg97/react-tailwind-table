...
import { Column, ColumnGroup, ColumnInstance } from 'react-table';
...
function App(): JSX.Element {
	const columns = React.useMemo<Column<ColumnProps>[]>(
		() => [
			{
				Header: 'Name',
				accessor: 'name' as keyof ColumnProps,
				Cell: AvatarCell,
				imgAccessor: 'imgUrl',
				emailAccessor: 'email',
			},
